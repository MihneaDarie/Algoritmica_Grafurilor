...
void meniuGrafO() ///aceasta functie genereaza de fiecare data o pagina in care se prelucreaza grafuri orientate
{
    ...
    setcolor(YELLOW);
    strcpy(titlu,"Grafuri Orientate");
    ...
    setcolor(WHITE);
    strcpy(titlu,"NR.MAX.ARCE");
    settextstyle(EUROPEAN_FONT, HORIZ_DIR, 1);
    outtextxy(1260,150,titlu);
    ...
    rectangle(1255, 310, 1445, 350);
    setcolor(WHITE);
    strcpy(titlu,"PLUS-MINUS");
    settextstyle(EUROPEAN_FONT, HORIZ_DIR, 1);
    outtextxy(1275,320,titlu);
    ...
    setcolor(WHITE);
    strcpy(titlu,"TRANSPUSA");
    settextstyle(EUROPEAN_FONT, HORIZ_DIR, 1);
    outtextxy(1280,500,titlu);
